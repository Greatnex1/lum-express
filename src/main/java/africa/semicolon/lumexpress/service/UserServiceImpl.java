...
import africa.semicolon.lumexpress.repository.AdminRepository;
import africa.semicolon.lumexpress.repository.CustomerRepository;
import africa.semicolon.lumexpress.repository.VendorRepository;
...
public class UserServiceImpl implements UserService{
    ...
    public LoginResponse login(LoginRequest loginRequest) {
       ...
       if (vendor.isPresent()&&vendor.get().getPassword().equals(loginRequest.getPassword()))
            return buildSuccessfulLoginResponse(vendor.get());
